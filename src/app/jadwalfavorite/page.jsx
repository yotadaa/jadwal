                    ...
                    <div>
                        <div className='flex flex-col items-center justify-center p-5 pl-3 pt-0 pb-0 ml-2'>
                            <div className='p-3 rounded-xl font-extrabold flex justify-start items-center w-full bg-white m-5 mb-1 shadow-xl'>
                                Kamu {context.countFavorite > 0 ? ` punya ${context.countFavorite} ` : "tidak punya "} jadwal favorit pada <span className='text-teal-600'> &nbsp; {" " + daftarHari[context.currentDay]}</span>
                            </div>
                        </div >
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {context.jadwal && context.jadwal.map((item, index) => {
                                            ...
                                            if (item.hari === context.currentDay && item.favorite) {
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <div className='flex items-center justify-center mt-6 font-extrabold text-xl'>{currentItem.judul}</div>
                                    <div
                                        className='p-5 '
                                    >
